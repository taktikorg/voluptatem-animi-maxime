[![npm](https://img.shields.io/npm/v/@taktikorg/voluptatem-animi-maxime.svg)](https://www.npmjs.com/package/@taktikorg/voluptatem-animi-maxime) ![downloads](https://img.shields.io/npm/dt/@taktikorg/voluptatem-animi-maxime.svg) [![CI](https://github.com/taktikorg/voluptatem-animi-maxime/actions/workflows/ci.yml/badge.svg)](https://github.com/taktikorg/voluptatem-animi-maxime/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@taktikorg/voluptatem-animi-maxime/renderer](https://www.npmjs.com/package/@@taktikorg/voluptatem-animi-maxime/renderer).

## tl;dr

- Install by executing `npm install @taktikorg/voluptatem-animi-maxime` or `yarn add @taktikorg/voluptatem-animi-maxime`.
- Import by adding `import { Document } from '@taktikorg/voluptatem-animi-maxime'`.
...
[Online demo](https://projects.wojtekmaj.pl/@taktikorg/voluptatem-animi-maxime/) is also available!
...
- [v6.x](https://github.com/taktikorg/voluptatem-animi-maxime/blob/v6.x/README.md)
- [v5.x](https://github.com/taktikorg/voluptatem-animi-maxime/blob/v5.x/README.md)
- [v4.x](https://github.com/taktikorg/voluptatem-animi-maxime/blob/v4.x/README.md)
- [v3.x](https://github.com/taktikorg/voluptatem-animi-maxime/blob/v3.x/README.md)
- [v2.x](https://github.com/taktikorg/voluptatem-animi-maxime/blob/v2.x/README.md)
- [v1.x](https://github.com/taktikorg/voluptatem-animi-maxime/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @taktikorg/voluptatem-animi-maxime` or `yarn add @taktikorg/voluptatem-animi-maxime`.
...
```ts
import { pdfjs } from '@taktikorg/voluptatem-animi-maxime';
...
import { Document, Page } from '@taktikorg/voluptatem-animi-maxime';
...
Check the [sample directory](https://github.com/taktikorg/voluptatem-animi-maxime/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/taktikorg/voluptatem-animi-maxime/wiki/Recipes) in [React-PDF Wiki](https://github.com/taktikorg/voluptatem-animi-maxime/wiki/).
...
```ts
import '@taktikorg/voluptatem-animi-maxime/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@taktikorg/voluptatem-animi-maxime/dist/Page/TextLayer.css';
```
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@taktikorg/voluptatem-animi-maxime__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@taktikorg/voluptatem-animi-maxime__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@taktikorg/voluptatem-animi-maxime__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@taktikorg/voluptatem-animi-maxime__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/taktikorg/voluptatem-animi-maxime/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@taktikorg/voluptatem-animi-maxime-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/voluptatem-animi-maxime-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@taktikorg/voluptatem-animi-maxime-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@taktikorg/voluptatem-animi-maxime-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@taktikorg/voluptatem-animi-maxime-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@taktikorg/voluptatem-animi-maxime-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@taktikorg/voluptatem-animi-maxime/contributors.svg?width=890&button=false)
